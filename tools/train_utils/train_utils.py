...
def train_one_epoch(model, optimizer, train_loader, accumulated_iter, optim_cfg,
    ...
    for cur_it in range(start_it, total_it_each_epoch):
        ...
        # if batch["input_dict"]["scenario_id"][0][0] != "af589661a6e54881806f9b1e4615319b_9f5b889dde994926aeda9fd7823ddec7":
        # print(batch["input_dict"]["scenario_id"][0][0])
        #     continue
        ...
        loss = loss / accumulation_steps if (cur_it+1)%accumulation_steps == 0 else loss / ((cur_it+1)%accumulation_steps)
...
def train_model(model, optimizer, train_loader, optim_cfg,
                ...
                logger_iter_interval=50, ckpt_save_time_interval=300, accumulation_steps=1):
