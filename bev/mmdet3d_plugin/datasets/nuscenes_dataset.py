...
class CustomNuScenesDataset(NuScenesDataset):
    ...
    def prepare_train_data(self, index):
        ...
        for i in index_list:
            ...
            #     return None
            queue.append({key:example[key][0] for key in example.keys()})
    ...
    def get_data_info(self, index):
        ...
        # actually, the nuScenes provides the rotation and translation of each sample, 
        # which is more accurate than we obtained from can bus. 
        ...
        can_bus[-1] = patch_angle # this angle is used to compute the delta of adjacent timestamps.
